const translations = {
    ...
    function setLang(code) {
      ...
      document.title = (translations[code] && translations[code].title ? translations[code].title : "Sign in") + " | TheTracker";
    ...
    document.title = (translations[l] && translations[l].title ? translations[l].title : "Sign in") + " | TheTracker";
