...
const translations = {
      ...
      en: {
        ...
        statusInvalidPhone: "Enter your mobile number, e.g. 0512345678 or +966512345678",
        statusError: "Something went wrong, please try again.",
        statusOauthFailed: "Google sign-in did not complete: the connection stopped before it finished. Please try again.",
        statusOauthCancelled: "Google sign-in was cancelled before it finished.",
      ...
      fr: {
        ...
        statusOauthFailed: "La connexion avec Google n'a pas abouti : la connexion s'est interrompue avant la fin. Réessayez.",
        statusOauthCancelled: "La connexion avec Google a été annulée avant la fin.",
      ...
      ur: {
        ...
        statusOauthFailed: "Google سائن ان مکمل نہیں ہوا، رابطہ منقطع ہو گیا۔ دوبارہ کوشش کریں۔",
        statusOauthCancelled: "Google سائن ان مکمل ہونے سے پہلے منسوخ کر دیا گیا۔",
        backBtn: "واپس ہوم",
