-- من يغيب عن المنصة تصله رسالة تيليغرام ودية بأرقام حسابه الحقيقية (أمر المهندس رعد 2026-09-08).
-- آخر ظهور يسجله المتصفح مرة في اليوم، والرسالة تخرج الساعة العاشرة بتوقيت المستخدم بعد يومين غياب،
-- ومرة كل ثلاثة أيام على الأكثر. مطبقة على القاعدة الحية باسم absence_nudge_over_telegram.
