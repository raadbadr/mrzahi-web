-- المهندس رعد 2026-09-08: «شخص حاب يسجل ليش لازم يدخل بيانات ويرفع اشياء عشان
-- يتسجل ترى شخص».
--
-- قاعدته الاصلية في الهجرة 0033 كانت عن الشركة: «الشركة اصلا ما تنحط الا لو تمت
-- اضافة سجل تجاري». وطبقت على كل الانواع، فصار الشخص يطالب برقم هوية قبل ان
-- يدخل. الشركة تبقى كما امر: سجل تجاري او رخصة الزاما. اما الشخص فيدخل بلا رقم،
-- وان كتب هويته سجلت كما هي في ورقة رسمية اولى.
