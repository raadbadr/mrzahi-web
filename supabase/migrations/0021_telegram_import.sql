-- استيراد إكسل من داخل بوت تلغرام (طلب المهندس رعد): الملف يقرأ في الـ Worker بمنطق
-- صفحة الاستيراد نفسه، يعرض ملخصه على المستخدم، وبالتأكيد تحفظ العناصر في شركته.
-- المسودة بين الخطوتين تحفظ هنا، والكتابة كلها عبر دوال محمية بسر الـ Worker.
