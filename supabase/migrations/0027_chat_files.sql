-- ملفات دردشة الفريق (طلب المهندس رعد): الملف يرفع إلى حاوية attachments بمسار منظم
-- (الشركة/chat/المحادثة/السنة-الشهر/الملف) وله صف في attachments، والرسالة تشير إليه.
-- وبما أن "كل شيء مربوط بشيء" يمكن ربط الملف بقضية أو مخالفة فيظهر في ملفها أيضا.
...
alter table public.attachments add column if not exists thread_key text;        -- 'team' أو معرف العضو في الخاص
