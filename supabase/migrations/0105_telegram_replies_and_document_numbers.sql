-- الترحيل كما طبق على Supabase (version 20260905101816, name telegram_replies_and_document_numbers); اضيف الى المستودع 2026-09-11 لسد فجوة الترحيلات
-- (1) ردود البوت تُسجل (كانت مرفوضة بقيد action) — (2) الأوراق تعيد رقمها هي وتاريخ إصدارها لا الرقم القياسي فقط
...
begin
  ...
  into result
  from (
    select i.id, i.item_number, i.title, i.status, i.due_at, i.client_name, i.case_number, i.amount, i.category, i.created_at, i.data, t.name as tracker_name
