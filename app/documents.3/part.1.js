    (function () {
      ...
      /* أسماء حقول الأوراق: مصدرها ملف القراءة نفسه (KIND_FIELDS) حتى لا يظهر
         ...
         على العربية ثم الإنجليزية، ولا يظهر المفتاح أبدا. */
      var DETAIL_LABELS = {
        account_name: { ar: "اسم صاحب الحساب", en: "Account holder" },
        account_number: { ar: "رقم الحساب", en: "Account No." },
        activity: { ar: "النشاط", en: "Activity" },
        address: { ar: "عنوان المكلف", en: "Taxpayer Address" },
        agent: { ar: "الوكيل", en: "Agent" },
        amount: { ar: "مبلغ المخالفة", en: "Amount" },
        annual_rent: { ar: "قيمة الإيجار السنوي", en: "Annual Rent" },
        bank_name: { ar: "اسم البنك", en: "Bank" },
        buyer: { ar: "العميل", en: "Buyer" },
        capital: { ar: "رأس المال", en: "Capital" },
        case_number: { ar: "رقم الدعوى", en: "Case No." },
        certificate_date: { ar: "تاريخ الشهادة", en: "Certificate date" },
        certificate_number: { ar: "رقم الشهادة", en: "Certificate No." },
        characteristics: { ar: "صفات الشركة", en: "Company Characteristics" },
        chassis_number: { ar: "رقم الهيكل", en: "Chassis No." },
        circuit: { ar: "الدائرة", en: "Circuit" },
        city: { ar: "المدينة", en: "City" },
        claim_amount: { ar: "قيمة المطالبة", en: "Claim Amount" },
        color: { ar: "اللون", en: "Color" },
        company_name: { ar: "اسم الشركة", en: "Company Name" },
        contract_date: { ar: "تاريخ العقد", en: "Contract Date" },
        contract_number: { ar: "رقم العقد", en: "Contract No." },
        court: { ar: "المحكمة", en: "Court" },
        coverage: { ar: "نوع التغطية", en: "Coverage" },
        ...
        description: { ar: "وصف المخالفة", en: "Description" },
        due_date: { ar: "تاريخ الاستحقاق", en: "Due Date" },
        duration: { ar: "مدة الشركة", en: "Duration" },
        effective_date: { ar: "تاريخ نفاذ التسجيل", en: "Effective Registration Date" },
        employee: { ar: "الموظف", en: "Employee" },
        employer: { ar: "صاحب العمل", en: "Employer" },
        end_date: { ar: "نهاية الوثيقة", en: "Expiry Date" },
        entity_type: { ar: "نوع الكيان", en: "Entity Type" },
        establishment_name: { ar: "اسم المنشأة", en: "Establishment Name" },
        establishment_number: { ar: "رقم المنشأة", en: "Establishment No." },
        filing_date: { ar: "تاريخ القيد", en: "Filing Date" },
        first_filing_due: { ar: "تاريخ استحقاق أول إقرار", en: "First Filing due date" },
        first_party: { ar: "الطرف الأول", en: "First Party" },
        fiscal_year: { ar: "السنة المالية", en: "Fiscal Year" },
        full_name: { ar: "الاسم", en: "Full Name" },
        grade: { ar: "الدرجة", en: "Grade" },
        headquarters: { ar: "المركز الرئيسي", en: "Head Office" },
        hearing_date: { ar: "تاريخ الجلسة", en: "Hearing Date" },
        hearing_time: { ar: "وقت الجلسة", en: "Hearing Time" },
        holder_name: { ar: "اسم المرخص له", en: "Licensee" },
        iban: { ar: "رقم الحساب الدولي", en: "IBAN" },
        id_number: { ar: "رقم الهوية", en: "ID Number" },
        insured: { ar: "المؤمن له", en: "Insured" },
        insurer: { ar: "شركة التأمين", en: "Insurer" },
        invoice_date: { ar: "تاريخ الفاتورة", en: "Invoice Date" },
        invoice_number: { ar: "رقم الفاتورة", en: "Invoice No." },
        issuer: { ar: "الجهة المصدرة", en: "Issuer" },
        job_title: { ar: "المهنة", en: "Job Title" },
        landlord: { ar: "المؤجر", en: "Landlord" },
        license_class: { ar: "نوع الرخصة", en: "Class" },
        license_number: { ar: "رقم الرخصة", en: "License No." },
        location: { ar: "الموقع", en: "Location" },
        make: { ar: "الماركة", en: "Make" },
        membership_number: { ar: "رقم العضوية", en: "Membership No." },
        model: { ar: "الطراز", en: "Model" },
        nationality: { ar: "الجنسية", en: "Nationality" },
        nitaqat_color: { ar: "النطاق", en: "Nitaqat" },
        notarization_number: { ar: "رقم التوثيق", en: "Notarization No." },
        owner: { ar: "اسم المالك", en: "Owner" },
        passport_number: { ar: "رقم الجواز", en: "Passport No." },
        permit_number: { ar: "رقم الرخصة", en: "License No." },
        place_of_issue: { ar: "مكان الإصدار", en: "Place of Issue" },
        plaintiff: { ar: "المدعي", en: "Plaintiff" },
        plate_number: { ar: "رقم اللوحة", en: "Plate No." },
        poa_number: { ar: "رقم الوكالة", en: "POA No." },
        policy_number: { ar: "رقم الوثيقة", en: "Policy No." },
        premium: { ar: "قسط التأمين", en: "Premium" },
        principal: { ar: "الموكل", en: "Principal" },
        property: { ar: "العقار", en: "Property" },
        ruling_date: { ar: "تاريخ الحكم", en: "Ruling Date" },
        ruling_number: { ar: "رقم الصك", en: "Ruling No." },
        salary: { ar: "الراتب", en: "Salary" },
        scope: { ar: "نص الوكالة", en: "Scope" },
        second_party: { ar: "الطرف الثاني", en: "Second Party" },
        seller: { ar: "المورد", en: "Seller" },
        serial_number: { ar: "الرقم التسلسلي", en: "Serial No." },
        start_date: { ar: "بداية الوثيقة", en: "Effective Date" },
        status: { ar: "حالة السجل", en: "Status" },
        subject: { ar: "موضوع الدعوى", en: "Subject" },
        subscription_number: { ar: "رقم الاشتراك", en: "Subscription No." },
        subtotal: { ar: "المجموع الفرعي", en: "Subtotal" },
        tax_period: { ar: "الفترة الضريبية", en: "Tax Period" },
        taxpayer_name: { ar: "اسم المكلف", en: "Taxpayer Name" },
        tenant: { ar: "المستأجر", en: "Tenant" },
        tin: { ar: "الرقم المميز", en: "TIN" },
        total: { ar: "الإجمالي", en: "Total" },
        total_value: { ar: "إجمالي قيمة العقد", en: "Total Contract Value" },
        unified_number: { ar: "الرقم الوطني الموحد", en: "Unified National Number" },
        value: { ar: "قيمة العقد", en: "Contract Value" },
        vat_amount: { ar: "قيمة الضريبة", en: "VAT Amount" },
        vat_number: { ar: "رقم التسجيل الضريبي", en: "VAT Registration Number" },
        verdict: { ar: "منطوق الحكم", en: "Verdict" },
        violation_date: { ar: "تاريخ المخالفة", en: "Violation Date" },
        violation_number: { ar: "رقم المخالفة", en: "Violation No." },
        violator: { ar: "المخالف", en: "Violator" },
        year: { ar: "سنة الصنع", en: "Model Year" }
      };

      function detailLabel(key, labels) {
        var pair = (labels || {})[key] || DETAIL_LABELS[key];
      ...
      var PROFILE_LABELS = {
        ...
        account_number: { ar: "رقم الحساب", en: "Account No.", fr: "N° de compte", ur: "اکاؤنٹ نمبر" },
        iban: { ar: "رقم الحساب الدولي", en: "IBAN", fr: "IBAN", ur: "IBAN" },
        bank_name: { ar: "اسم البنك", en: "Bank", fr: "Banque", ur: "بینک" },
        account_name: { ar: "اسم صاحب الحساب", en: "Account holder", fr: "Titulaire du compte", ur: "اکاؤنٹ ہولڈر" }
      };
