...
try{["lang","theme","org","sidebar","dash_tab","bell_seen","chat_seen","cal_mode","cal_zoom","dp_cal","drive_folder","tr"].forEach(function(k){var o=localStorage.getItem("record_"+k);if(o!==null&&localStorage.getItem("mrzahi_"+k)===null){localStorage.setItem("mrzahi_"+k,o);localStorage.removeItem("record_"+k);}});}catch(e){}
    const translations = {
      ar: {
        ...
        step4Title: "4. السجل",
        recordLabel: "أضف العناصر إلى",
        newRecord: "سجل جديد",
        recordNamePlaceholder: "اسم السجل الجديد",
        recordNameRequired: "أدخل اسم السجل الجديد.",
        ...
        progressCreatingRecord: "جاري إنشاء السجل...",
        ...
        summaryRecord: "أضيفت العناصر إلى السجل: {name}",
      ...
      en: {
        ...
        subtitle: "Upload an Excel or CSV file, map its columns to the record fields, and we will handle the rest.",
        loading: "Loading...",
        ...
        step4Title: "4. Record",
        recordLabel: "Add the items to",
        newRecord: "New record",
        recordNamePlaceholder: "Name of the new record",
        recordNameRequired: "Enter a name for the new record.",
        ...
        progressCreatingRecord: "Creating the record...",
        ...
        summaryRecord: "The items were added to the record: {name}",
      ...
      fr: {
        ...
        step4Title: "4. Suivi",
        recordLabel: "Ajouter les éléments à",
        newRecord: "Nouveau suivi",
        recordNamePlaceholder: "Nom du nouveau suivi",
        recordNameRequired: "Saisissez un nom pour le nouveau suivi.",
        ...
        progressCreatingRecord: "Création du suivi...",
        ...
        summaryRecord: "Les éléments ont été ajoutés au suivi : {name}",
    ...
    const placeholderKeys = { recordName: "recordNamePlaceholder" };
    ...
    function setLang(code) {
      ...
      document.title = (translations[code] && translations[code].title ? translations[code].title : "Import") + " | MrZahi";
    ...
    document.title = (translations[l] && translations[l].title ? translations[l].title : "Import") + " | MrZahi";
