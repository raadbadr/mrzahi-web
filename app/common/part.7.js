...
(function () {
  ...
  var T = {
    ar: { title: "مساعد الاوامر", open: "افتح مساعد الاوامر", close: "اغلاق",
          ...
          inOrg: "سينفذ في:", ph: "اكتب امرك هنا", send: "ارسال", run: "نفذ", cancel: "الغاء", thinking: "...",
    ...
    en: { title: "Command assistant", open: "Open command assistant", close: "Close",
          ...
          inOrg: "Will run in:", ph: "Type your command", send: "Send", run: "Run", cancel: "Cancel", thinking: "...",
    ...
    fr: { title: "Assistant de commandes", open: "Ouvrir l'assistant", close: "Fermer",
          ...
          inOrg: "Sera execute dans :", ph: "Ecrivez votre commande", send: "Envoyer", run: "Executer", cancel: "Annuler", thinking: "...",
    ...
    ur: { title: "کمانڈ اسسٹنٹ", open: "اسسٹنٹ کھولیں", close: "بند کریں",
          ...
          inOrg: "یہاں چلے گا:", ph: "اپنا حکم لکھیں", send: "بھیجیں", run: "چلائیں", cancel: "منسوخ", thinking: "...",
  ...
  var STYLE = [
    ...
    ".agent-messages .chat-msg-author{font-size:.72rem;color:var(--text-secondary);padding:0 .4rem;}",
  ...
  function offer(res) {
    ...
    /* اسم الحساب الذي سينفذ فيه: صار صادقا بعد الترحيل 0165، فالخادم يضبط نطاق
       المساعد على الحساب المفتوح قبل ان يعرض شيئا، فلا يعد باسم ويكتب في غيره */
    if (res.org && res.org.name) msg.appendChild(el("div", "chat-msg-author", t("inOrg") + " " + res.org.name));
  ...
  function mount() {
    ...
    /* لا يكتب اسم حساب فوق الدردشة قبل ان يطلب شيئا: يظهر في بطاقة التاكيد وحدها
       حيث يلزم، باسم الحساب الذي ضبطه الخادم فعلا. */
