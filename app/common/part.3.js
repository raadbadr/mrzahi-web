  ...
  var SIDEBAR_CSS = [
    ...
    ".sar-symbol{display:inline-block;width: 1.3em;height: 1.3em;vertical-align: -0.24em;background-color:currentColor;-webkit-mask:url(/rial-symbol.png) center/contain no-repeat;mask:url(/rial-symbol.png) center/contain no-repeat;margin:0 .12em}",
