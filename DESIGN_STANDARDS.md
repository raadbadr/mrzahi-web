...
> الثيم موروث حرفيا من موقع Parkinzi (NeumorphicTheme) ولا يعدل — خط أحمر للمالك. كل ما يخص MrZahi هنا هو الشعار فقط.
...
**ملاحظة:** الثيم (الألوان، المسافات، الزوايا، الزجاج، الظلال، الخطوط، الحركات) موروث حرفيا من Parkinzi ولا يتغير
