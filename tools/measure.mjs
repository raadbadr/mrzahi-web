...
function stub(url, method, body) {
  ...
  if (p.includes("/rest/v1/rpc/my_services")) return ["dashboard", "cases", "violations", "team", "settings", "documents", "processes", "risks", "expenses", "staff", "leaves", "training"];
  ...
  const PACK_ROWS = [
    ...
    ["hr", "موارد بشرية", "الموظفون وعقودهم ووثائقهم ورواتبهم وإجراءات التوظيف", "M16 11c1.66 0 3-1.34 3-3s-1.34-3-3-3-3 1.34-3 3 1.34 3 3 3z", [["dashboard",null],["staff","الموظفون"],["leaves","الاجازات"],["training","الدورات والمؤهلات"],["team",null],["expenses","الرواتب والمصاريف"],["documents","العقود والوثائق"],["processes","إجراءات التوظيف"],["settings",null]]],
