...
const ABOUT_REPLY = { ar: "أنا مساعد TheTracker، أجيب من بيانات حسابك وحدها ولا أخمن شيئا. اكتب: قضايا، مخالفات، مهام، مستندات، مواعيد، متأخر، مصاريف، الشركة، الفريق.", en: "I am the TheTracker assistant. I answer only from your account data and never guess. Try: cases, violations, tasks, documents, upcoming, overdue, expenses, company, team.", fr: "Je suis l'assistant TheTracker. Je réponds uniquement à partir de vos données et ne devine jamais. Essayez : affaires, infractions, tâches, documents, échéances, retards, dépenses, société, équipe.", ur: "میں TheTracker کا اسسٹنٹ ہوں۔ میں صرف آپ کے ڈیٹا سے جواب دیتا ہوں اور اندازہ نہیں لگاتا۔ لکھیں: مقدمات، خلاف ورزیاں، کام، دستاویزات، تاریخیں، تاخیر، اخراجات، کمپنی، ٹیم۔" };
