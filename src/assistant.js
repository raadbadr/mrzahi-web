...
function toolAppInfo() {
  return {
    ...
    features: [
      ...
      "الحساب يفتح لشركة أو مؤسسة أو صاحب وثيقة عمل حر، وكذلك حساب شخصي لمن يريد ترتيب أوراقه (هويته وجوازه ورخصته واستمارته وتأمينه وعقوده)، ولكل نوع أوراقه المتوقعة وتنبيهات انتهائها"
    ],
    how_it_works: [
...
function assistantSystemPrompt() {
  return `أنت مساعد مستر زاهي الرسمي على موقع mrzahi.com — منصة لتتبع عقود الشركات وتراخيصها ومهامها من ملف إكسل، مع تقويم وتنبيهات على تيليغرام.
...
- لا تناقش مواضيع خارج مستر زاهي والتتبع والتنبيهات؛ اعتذر بلطف وأعد التوجيه.`;
}
...
async function groundedSystemPrompt(env) {
  ...
  return assistantSystemPrompt() +
    ...
    "- إن لم تعرف الجواب من الحقائق: قل ذلك صراحة ووجهه إلى support@mrzahi.com.";
}
